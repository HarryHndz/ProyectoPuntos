...
export const Formulario = (Cuadro) => {
    ...
    return (
            ...
            from-blue-900 to-violet-500 text-center">Factor de ajuste de valor</h1>
                ...
                <div className="flex justify-center items-center my-5">
                    <caption class="caption-bottom">*Responda las 14 preguntas indicadas y establezca un valor a cada una desde 1 (no importante) a 6 (absolutamente esencial)</caption>
                </div>
                <div className="flex justify-center items-center my-5">
                <form onSubmit={ev => {
                    ev.preventDefault();
                    ...
                    <br />
                    <input type="number" min="1" max="6" name="p1" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 
                    ...
                    <br />
                    <input type="number" min="1" max="6" name="p2" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    ...
                    <br />
                    <input type="number" min="1" max="6" name="p3" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />

                    <label>4. ¿El desempeño es crucial?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p4" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />

                    <label>5. ¿El sistema correrá en un entorno operativo existente enormemente utilizado?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p5" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />

                    <label>6. ¿El sistema requiere entrada de datos en línea?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p6" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />
                    ...
                    <br />
                    <input type="number" min="1" max="6" name="p7" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />

                    <label>8. ¿Los ALI se actualizan en línea?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p8" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />
                    ...
                    complejos?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p9" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />

                    <label>10. ¿El procesamiento interno es complejo?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p10" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />

                    <label>11. ¿El código se diseña para ser reutilizable?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p11" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"/>
                    <br />
                    ...
                    diseñ?</label>
                    <br />
                    <input type="number" min="1" max="6" name="p12" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />
                    ...
                    <br />
                    <input type="number" min="1" max="6" name="p13" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
                    placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" />
                    <br />

                    <label>14. ¿La aplicación se diseña para facilitar el cambio y su 
                    uso por parte del usuario?</label>
                    <input type="number" min="1" max="6" name="p14" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 
