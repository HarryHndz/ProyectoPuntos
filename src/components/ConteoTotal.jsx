    ...
    return(
        ...
        <form onSubmit={ev =>{
            ...
            <table>
                ...
                <tr>
                    <td coldspan="5"><button type="submit">Continuar</button></td>
                </tr>
            </table>
        </form>
...
//                <>
//                <Formulario />
//                <button onClick={regresar}>Retroceder</button>
//                </>
//            ) : (
//                <>
//                    <form onSubmit={ev =>{
...
//                            </tr>
//                            <tr>
//                                <td coldspan="5"><button type="submit" onClick={seguir}>Continuar</button></td>
//                            </tr>
//                        </table>
//                    </form>
//                </>
