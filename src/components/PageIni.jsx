    ...
    return (
        <div>
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                ...
                <h1 className="text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-900 to-violet-500">
                ...
                <div className="mt-10">
                    ...
                    className="inline-block rounded-md bg-indigo-600 px-8 py-3 text-center font-medium text-white 
                    hover:bg-indigo-700"
                    >
                    Comenzar
                    </button>
